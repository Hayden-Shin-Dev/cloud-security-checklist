...
| Copyright | Copyright (c) 2026 Hayden Shin |
| License | MIT License |

이 프로젝트의 원 제작자는 Hayden Shin입니다. 재사용, 배포, 수정 시 저장소의 `LICENSE`에 포함된 저작권 및 라이선스 고지 조건을 유지해야 합니다.
